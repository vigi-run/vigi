...
export const putAuthProfile = <ThrowOnError extends boolean = false>(options: Options<PutAuthProfileData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutAuthProfileResponses, PutAuthProfileErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
 ...
 */
export const getInvitationsByToken = <ThrowOnError extends boolean = false>(options: Options<GetInvitationsByTokenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetInvitationsByTokenResponses, GetInvitationsByTokenErrors, ThrowOnError>({
        responseType: 'json',
 ...
 * Accept invitation
 */
export const postInvitationsByTokenAccept = <ThrowOnError extends boolean = false>(options: Options<PostInvitationsByTokenAcceptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostInvitationsByTokenAcceptResponses, PostInvitationsByTokenAcceptErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
 ...
 * Update organization
 */
export const patchOrganizationsById = <ThrowOnError extends boolean = false>(options: Options<PatchOrganizationsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchOrganizationsByIdResponses, PatchOrganizationsByIdErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
 ...
 */
export const getStorageConfig = <ThrowOnError extends boolean = false>(options?: Options<GetStorageConfigData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetStorageConfigResponses, unknown, ThrowOnError>({
        responseType: 'json',
        url: '/storage/config',
        ...options
    });
 ...
 */
export const postStoragePresignedUrl = <ThrowOnError extends boolean = false>(options: Options<PostStoragePresignedUrlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostStoragePresignedUrlResponses, PostStoragePresignedUrlErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
 ...
 */
export const getUserInvitations = <ThrowOnError extends boolean = false>(options?: Options<GetUserInvitationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUserInvitationsResponses, GetUserInvitationsErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                name: 'Authorization',
