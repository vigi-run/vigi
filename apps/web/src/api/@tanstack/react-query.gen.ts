 ...
 * Update user profile
 */
export const putAuthProfileMutation = (options?: Partial<Options<PutAuthProfileData>>): UseMutationOptions<PutAuthProfileResponse, AxiosError<PutAuthProfileError>, Options<PutAuthProfileData>> => {
    const mutationOptions: UseMutationOptions<PutAuthProfileResponse, AxiosError<PutAuthProfileError>, Options<PutAuthProfileData>> = {
        mutationFn: async (localOptions) => {
...
export const getInvitationsByTokenQueryKey = (options: Options<GetInvitationsByTokenData>) => createQueryKey('getInvitationsByToken', options);

/**
 * Get invitation details (public)
 */
export const getInvitationsByTokenOptions = (options: Options<GetInvitationsByTokenData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getInvitationsByToken({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getInvitationsByTokenQueryKey(options)
    });
};

export const postInvitationsByTokenAcceptQueryKey = (options: Options<PostInvitationsByTokenAcceptData>) => createQueryKey('postInvitationsByTokenAccept', options);

/**
 * Accept invitation
 */
export const postInvitationsByTokenAcceptOptions = (options: Options<PostInvitationsByTokenAcceptData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postInvitationsByTokenAccept({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postInvitationsByTokenAcceptQueryKey(options)
    });
};
 ...
 * Accept invitation
 */
export const postInvitationsByTokenAcceptMutation = (options?: Partial<Options<PostInvitationsByTokenAcceptData>>): UseMutationOptions<PostInvitationsByTokenAcceptResponse, AxiosError<PostInvitationsByTokenAcceptError>, Options<PostInvitationsByTokenAcceptData>> => {
    const mutationOptions: UseMutationOptions<PostInvitationsByTokenAcceptResponse, AxiosError<PostInvitationsByTokenAcceptError>, Options<PostInvitationsByTokenAcceptData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postInvitationsByTokenAccept({
                ...options,
                ...localOptions,
 ...
 * Update organization
 */
export const patchOrganizationsByIdMutation = (options?: Partial<Options<PatchOrganizationsByIdData>>): UseMutationOptions<PatchOrganizationsByIdResponse, AxiosError<PatchOrganizationsByIdError>, Options<PatchOrganizationsByIdData>> => {
    const mutationOptions: UseMutationOptions<PatchOrganizationsByIdResponse, AxiosError<PatchOrganizationsByIdError>, Options<PatchOrganizationsByIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await patchOrganizationsById({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getStorageConfigQueryKey = (options?: Options<GetStorageConfigData>) => createQueryKey('getStorageConfig', options);

/**
 * Get storage configuration
 */
export const getStorageConfigOptions = (options?: Options<GetStorageConfigData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getStorageConfigQueryKey(options)
    });
};

export const postStoragePresignedUrlQueryKey = (options: Options<PostStoragePresignedUrlData>) => createQueryKey('postStoragePresignedUrl', options);

/**
 * Get presigned URL for file upload
 */
export const postStoragePresignedUrlOptions = (options: Options<PostStoragePresignedUrlData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postStoragePresignedUrl({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postStoragePresignedUrlQueryKey(options)
    });
};
 ...
 * Get presigned URL for file upload
 */
export const postStoragePresignedUrlMutation = (options?: Partial<Options<PostStoragePresignedUrlData>>): UseMutationOptions<PostStoragePresignedUrlResponse, AxiosError<PostStoragePresignedUrlError>, Options<PostStoragePresignedUrlData>> => {
    const mutationOptions: UseMutationOptions<PostStoragePresignedUrlResponse, AxiosError<PostStoragePresignedUrlError>, Options<PostStoragePresignedUrlData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postStoragePresignedUrl({
                ...options,
                ...localOptions,
 ...
 */
export const getUserInvitationsOptions = (options?: Options<GetUserInvitationsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
