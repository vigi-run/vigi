...
// Add type for selected item with label
type SelectedItem = {
    label: string;
    value: string;
    icon?: React.ComponentType<{ className?: string }>;
...
>(
    (
        ...
        // Update selectedItems when selectedValues or options change
        React.useEffect(() => {
            setSelectedItems((prevSelectedItems) => {
                return selectedValues.map((value) => {
                    ...
                    // If not found in options, try to find in existing selectedItems
                    const existingItem = prevSelectedItems.find((item) => item.value === value);
                    if (existingItem) {
                        return existingItem;
                    }
                    // If not found anywhere, use value as label
                    return { label: value, value };
                });
            });
        }, [selectedValues, options]);

        // Filter options based on search while keeping selected items visible
            ...
            >
                            ...
                            <div className="flex justify-between items-center w-full">
                                <div className="flex flex-wrap items-center">
                                    {selectedValues.slice(0, maxCount).map((value) => {
                                        // Use selectedItems instead of searching in options
                ...
                >
                    <Input
                        ...
                        className="border-none rounded-none border-b focus-visible:ring-0"
                    />
