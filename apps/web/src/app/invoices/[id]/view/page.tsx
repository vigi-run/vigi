          ...
          <div className="flex items-center rounded-md shadow-sm">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => emitMutation.mutate()} disabled={emitMutation.isPending || !invoice.organizationId}>
                ...
                {!invoice.bankInvoiceId && (
                  <DropdownMenuItem onClick={handleGenerateCharge} disabled={isGeneratingCharge}>
                    ...
                    {isGeneratingCharge ? t("common.loading") : t("invoice.actions.generate_charge")}
                  </DropdownMenuItem>
                )}
