...
import type { OrganizationInvitation, OrganizationOrganizationUser } from "@/api/types.gen";
...
export default function OnboardingPage() {
  ...
  const invitations = (invitationsData?.data?.data || []) as OrganizationInvitation[];
  const organizations = (orgsData?.data || []) as OrganizationOrganizationUser[];
