...
type Repository interface {
	...
	UpdateFull(ctx context.Context, id string, entity *Model, orgID string) (*Model, error)
	UpdatePartial(ctx context.Context, id string, entity *UpdateModel, orgID string) (*Model, error)
